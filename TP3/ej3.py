...
# mlp = MultiLayerPerceptron(0.001, tanh, tanhPrime, 35, [4, 2], 1,  a=1e-7, b=1e-4)
...
#-----------------------------------------------------#
# RECONOCE NUMEROS EXPRESADOS EN VECTORES DE 1X35, OUTPUTS DE 1X10
#
...
mlp = MultiLayerPerceptron(0.001, tanh, tanhPrime, 35, [25, 15], 10,  a=1e-7, b=1e-4, update=ct.UPDATE_MOMENTUM)
mlp.train(X, y, adaptative=True)
...
mlp = MultiLayerPerceptron(0.01, tanh, tanhPrime, 10, [10, 10], 10,  a=1e-7, b=1e-4)
mlp.train(X, y,  minError = 5e-3, adaptative=True)
