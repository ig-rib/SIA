...
# mlp = MultiLayerPerceptron(0.001, tanh, tanhPrime, 35, [30, 25, 20, 15, 10, 5, 2], 1,  a=1e-7, b=1e-4)
...
mlp = MultiLayerPerceptron(0.01, tanh, tanhPrime, 10, [10, 4, 2], 1,  a=1e-7, b=1e-4)
mlp.train(X, y, adaptative=True)
